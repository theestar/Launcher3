        ...
        switch (newIconIndex) {
            ...
            case FocusLogic.PREVIOUS_PAGE_RIGHT_COLUMN:
                ...
                if (prevPage != null && prevPage
                        .getShortcutsAndWidgets() != null && prevPage
                        .getShortcutsAndWidgets().getChildAt(0) != null && prevPage
                        .getShortcutsAndWidgets().getChildAt(0).getLayoutParams() != null) {
            ...
            case FocusLogic.NEXT_PAGE_RIGHT_COLUMN:
                ...
                if (nextPage != null && nextPage
                        .getShortcutsAndWidgets() != null && nextPage
                        .getShortcutsAndWidgets().getChildAt(0) != null && nextPage
                        .getShortcutsAndWidgets().getChildAt(0).getLayoutParams() != null) {
