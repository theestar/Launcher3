...
public class HolographicOutlineHelper {
    ...
    Bitmap createMediumDropShadow(BubbleTextView view) {
        ...
        Log.d("HolographicOutlineHelper",
                "createMediumDropShadow() rect.width() = " + rect.width()
                        + " ;rect.height = " + rect.height());

        int bitmapWidth = (int) (rect.width() * view.getScaleX());
        int bitmapHeight = (int) (rect.height() * view.getScaleY());
        Log.d("HolographicOutlineHelper",
                "createMediumDropShadow() bitmapWidth = " + bitmapWidth
        ...
        if (cache == null) {
            if (bitmapWidth > 0 && bitmapHeight > 0) {
                cache = Bitmap.createBitmap(bitmapWidth, bitmapHeight,
