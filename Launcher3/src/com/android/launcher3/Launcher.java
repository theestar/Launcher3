...
import com.sprd.android.config.OptConfig;//wangxing add 20170329
/**
...
public class Launcher extends Activity
    ...
    @Thunk void completeTwoStageWidgetDrop(final int resultCode, final int appWidgetId) {
        /*  SPRD: add for bug599223 add the selection .@{*/
        if (mWorkspace == null){
            return;
        }
        /* @} */
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (isActionMain) {
            ...
            if (alreadyOnHome) {
                //jiazhenl 20170322 modify for bug51319
                //showWorkspace(true);
                showWorkspace(false);
            } else {
    ...
    @Thunk void showFirstRunClings() {
        ...
        if (launcherClings.shouldShowFirstRunOrMigrationClings()) {
            ...
            /* wangxing 20170329 start @{ */
            if(OptConfig.SUN_C7301_XT_503_FWVGA){
	            try{
	                Intent intent = this.getPackageManager().getLaunchIntentForPackage("com.myphone.myregister");
	                startActivity(intent);
	            }catch(Exception e){
	                Toast.makeText(this, "verykool not found!", Toast.LENGTH_LONG).show();
	            }
	        }
	        /* wangxing 20170329 end @} */
        }
    }
