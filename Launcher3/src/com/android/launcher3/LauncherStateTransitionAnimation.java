            ...
            public AnimatorListenerAdapter getMaterialRevealViewAnimatorListener(
                ...
                return new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        // Hide the reveal view
                        revealView.setVisibility(View.INVISIBLE);
                        Log.d(TAG, "startAnimationToWorkspaceFromAllApps revealView isVisible = "
                                + (View.INVISIBLE == revealView.getVisibility()));
        ...
        if (animated && initialized) {
            ...
            animation.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    cleanupAnimation();
                    pCb.onTransitionComplete();
                    Log.d(TAG, "startAnimationToWorkspaceFromOverlay contentView isVisible = "
                            + (contentView != null ? contentView.getVisibility() + "" : "contentView is null")
                            + "  revealView isVisible = "
                            + (revealView != null ? revealView.getVisibility() + "":"revealView is null"));
                }
            });
