...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected boolean mInOverviewMode;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_UP:
            if (mTouchState == TOUCH_STATE_SCROLLING) {
                ...
                final int pageWidth = getPageAt(mCurrentPage) == null ? 0 : getPageAt(mCurrentPage).getMeasuredWidth();
    ...
    public void setInOverviewMode(boolean isInOverviewMode){
        mInOverviewMode = isInOverviewMode;
    };
